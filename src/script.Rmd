...
```
## Check the ROE movement in Canada
```{r}
...
# did w fixed effect generated from Stata
<!-- $\[ -->
<!-- \text{ROE}_{it} = \beta_0 + \beta_1 \text{TP}_{it} + \beta_2 \text{T1CR}_{it} + \beta_3 \text{GDP}_{it} + \beta_4 \text{CPI}_{it} + \beta_5 \text{stock_idx}_{it} + \alpha_i + \gamma_t + \epsilon_{it} -->
<!-- \]$ -->

| Variable    | Coefficient | Std. Err. | t     | P>abs(t)    | 90% Conf. Interval      |
|-------------|-------------|-----------|-------|------------|-----------------------|
| TP          | **-6.190274**   | 3.132214  | -1.98 | 0.051 | -11.39 to -0.99   |
| t1cr        | **0.6889748**   | 0.3686563 | 1.87  | 0.064 | 0.08 to 1.30     |
| gdp         | **-0.0099364**  | 0.0041104 | -2.42 | 0.017 | -0.02 to -0.00   |
| cpi         | **1.811661**    | 1.025921  | 1.77  | 0.080 | 0.11 to 3.51   |
| stock_idx   | 0.0169595   | 0.0705168 | 0.24  | 0.810 | -0.10 to 0.13  |
| _cons       | **279.2408**    | 121.7997  | 2.29  | 0.024 | 77.20 to 481.29      |




### HDFE Regression Statistics
